...
من المثير للاهتمام أن كل ميزة تزامن (concurrency) تحدثنا عنها تقريباً حتى الآن في هذا الفصل كانت جزءاً من المكتبة القياسية، وليس اللغة. خياراتك للتعامل مع التزامن ليست مقتصرة على اللغة أو المكتبة القياسية؛ يمكنك كتابة ميزات التزامن الخاصة بك أو استخدام تلك المكتوبة بواسطة الآخرين.
