...
قبل أن نبدأ، يجب أن نذكر تفصيلتين. أولاً، الطريقة التي سنستخدمها لن تكون أفضل طريقة لبناء خادوم ويب (web server) باستخدام Rust. نشر أعضاء المجتمع عددًا من الحزم (crates) الجاهزة للإنتاج المتاحة على [crates.io](https://crates.io/) والتي توفر تطبيقات أكثر اكتمالاً لخادوم الويب (web server) ومجمع الخيوط (thread pool) مما سنبنيه. ومع ذلك، فإن نيتنا في هذا الفصل هي مساعدتك على التعلم، وليس اتخاذ الطريق السهل. نظرًا لأن Rust هي لغة برمجة أنظمة (systems programming language)، يمكننا اختيار مستوى التجريد (level of abstraction) الذي نريد العمل به ويمكننا الذهاب إلى مستوى أدنى مما هو ممكن أو عملي في لغات أخرى.
