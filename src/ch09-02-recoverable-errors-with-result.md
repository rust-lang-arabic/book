...
الدالة في سطر واحد. إذا لم نتمكن من استخدام معامل `?` على `Option`، كان سيتعين
...
`Result`، ويمكنك استخدام معامل `?` على `Option` في دالة
تُرجع `Option`، لكن لا يمكنك المزج والمطابقة. لن يحول معامل `?`
