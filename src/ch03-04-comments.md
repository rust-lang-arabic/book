...
في Rust، يبدأ أسلوب التعليق (comment) الاصطلاحي تعليقاً بشرطتين مائلتين، ويستمر
التعليق حتى نهاية السطر. بالنسبة للتعليقات (comments) التي تمتد إلى ما بعد سطر
