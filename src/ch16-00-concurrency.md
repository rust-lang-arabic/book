...
البرمجة المتزامنة، التي تُنفذ فيها أجزاء مختلفة من البرنامج بشكل مستقل، والبرمجة المتوازية (Parallel programming)، التي تُنفذ فيها أجزاء مختلفة من البرنامج في نفس الوقت، أصبحتا أكثر أهمية مع استفادة المزيد من أجهزة الكمبيوتر من معالجاتها المتعددة. تاريخياً، كانت البرمجة في هذه السياقات صعبة وعرضة للأخطاء. تأمل Rust في تغيير ذلك.
